...
api_key = "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"
...
st.title("💬 매니저봇 생성형 GPT 챗봇 (Key 포함)")
st.caption("사장님, 무엇이든 질문해 주세요. 매니저가 바로 응답해드립니다.")
